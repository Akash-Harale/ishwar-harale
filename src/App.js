    ...
    >
      <Flex
        ...
        >
          ...
          >
            <Box width='100px'>
              <Image width='50%' src="https://skill-lync.com/images/newheader/logo.png" />
            </Box>
            <Box
              fontSize={["16px", "16px", "16px"]}
            >
              <Text fontSize="lg">Skill lyc Technologies</Text>
              <Text as="h3" fontSize='xl' fontWeight="bold">Backend Developer</Text>
              <Text>Applied on 25/11/2022</Text>
            </Box>
          </Box>
          <Box>
